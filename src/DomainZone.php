...
{
    /**
     * Проверяет, является ли строка допустимой доменной зоной верхнего уровня (TLD).
     *
     * @param  string  $tld  Доменная зона для проверки.
     * @return bool True, если TLD допустимый, иначе False.
     */
